# -*- coding: utf-8 -*-
"""
Created on Wed Jul 17 13:03:17 2024
...
def normal(ray, ellipse, normal, params):
    ...
    if len(xi) == 1: #Selects depending on number of intersection points
        ...
        # print('ERROR! No normal intersections found')
        return(0)
    else:
        # print('ERROR! Normal intersection error!')  
        return(0)
    ...
    #(6.c) Case 3 
        ...
        if x_non > 0 and y_non >= 0:
            ...
            print('ERROR! n_i is undefined for (x_i,y_i) = (0,0) (NORMAL)\n')
            return('ERROR \n')
        #Finding the normal
        ...
        if x_non > 0 and y_non >= 0:
           ...
           print('ERROR! n_i is undefined for (xi , yi) = (0,0) (NORMAL)\n')
           return('ERROR \n')
    return(ni, Ti, xi, yi)
